                ...
                <div key={client.id}>
                  <div className="flex items-center gap-3 px-4 py-3"
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <button onClick={() => setContratoUser(client)}
                      ...
                      <button onClick={() => selectClient(client)}
                        className="text-xs px-2.5 py-1 rounded-lg font-medium"
                        style={{
                          background: isOpen ? '#007AFF' : 'var(--bg-border)',
                          color: isOpen ? 'white' : 'var(--text-lo)',
                        }}>
                        {isOpen ? 'Fechar' : 'Dispositivos'}
                      </button>
                    </div>
                  </div>

                  {/* Expanded devices panel */}
                  {isOpen && (
                              ...
                              <div className="space-y-2">
                                {unassigned.map(device => (
                                  <div key={device.id} className="flex items-center justify-between rounded-xl px-3 py-2.5"
                                    ...
                                    <button onClick={() => assignDevice(client.id, device.id)}
                                      className="text-xs px-2.5 py-1 rounded-lg font-medium"
