    ...
    <div className="flex flex-col sidebar-offset" style={{ height: '100dvh', background: 'var(--bg-page)' }}>
      ...
      <header className="flex-shrink-0 flex items-center justify-between px-4 h-14"
        ...
        <div className="flex items-center gap-2">
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#007AFF" strokeWidth="2" strokeLinecap="round" className="hidden md:block">
            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
            <circle cx="9" cy="7" r="4"/>
            <path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/>
          </svg>
          <h1 className="font-bold t-text-hi hidden md:block">Gestão</h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setShowConfig(true)} className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
            style={{ background: 'var(--bg-border)' }} title="Configurações">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--text-lo)" strokeWidth="2" strokeLinecap="round">
