      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">
            WEEV<span className="text-violet-400">ZAP</span>
          </h1>
          <p className="text-slate-400 text-sm mt-1">Dashboard de Atendimento</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-700/60 rounded-2xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-violet-600 hover:bg-violet-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold text-sm rounded-lg py-2.5 transition-colors mt-1"
            >
